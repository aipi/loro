...
const ANSWERS = {
  ...
  brain_list_acervos: { acervos: [{ id: "exemplo", name: "Exemplo", dir: "/tmp/acervo", color: "", lang: "pt", template: "generico", agent: "claude", autoContext: true, ticketBase: "" }], active: "exemplo" },
